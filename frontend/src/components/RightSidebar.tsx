...
import { BellIcon, CameraIcon, CheckIcon, ChevronLeftIcon, ChevronRightIcon, DepartmentIcon, LogOutIcon, TrashIcon, UserIcon, CloseIcon, SpinnerIcon } from './Icons'
...
export const RightSidebar = memo(function RightSidebar({
  ...
  const handleCropComplete = useCallback(async (croppedImage: Blob) => {
    ...
    try {
      ...
      const newFileName = `profile_${Date.now()}.png`
      const newStorageRef = ref(storage, `users/${user.uid}/${newFileName}`)

      await uploadBytes(newStorageRef, croppedImage)
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <div className="group relative mb-4">
                <div className="relative h-24 w-24">
                  <div className="h-24 w-24 overflow-hidden rounded-full ring-4 ring-gray-300 dark:ring-secondary-700">
                    {avatar}
                  </div>
                  <button
                    type="button"
