  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="relative flex h-[2.875rem] w-full items-center justify-between gap-3 rounded-md border border-gray-200 bg-white pl-4 pr-3 text-sm font-bold text-gray-600 outline-none transition hover:border-gray-300 hover:shadow-md focus:border-gray-300 active:shadow-none shadow-sm"
      >
