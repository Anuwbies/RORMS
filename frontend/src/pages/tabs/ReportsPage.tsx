              ...
              <div className="rounded-xl border border-gray-100 bg-white p-5 shadow-sm flex items-center">
                <div className="flex-1">
                  ...
                  <div className="mt-2 space-y-1">
                    <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-green-500"></div><span className="text-sm">75% Approved</span></div>
                    <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-yellow-500"></div><span className="text-sm">15% Pending</span></div>
                    <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-red-500"></div><span className="text-sm">10% Rejected</span></div>
                  </div>
                </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white overflow-hidden shadow-sm">
                  ...
                  <tbody className="divide-y divide-gray-100 bg-white">
                    {[
                      ...
                      <tr key={i} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4">
                          <span className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${row.statusColor.replace('bg-', 'ring-').replace('100', '500/20').replace('text', 'bg').replace('800', '50').replace('bg-', 'text-')}`}>
                            {row.status}
                          </span>
                        </td>
                      </tr>
              ...
              <div className="flex items-center justify-between border-t border-gray-100 bg-gray-50/50 px-6 py-4">
                <p className="text-sm text-gray-700">
                  Showing <span className="font-medium">1</span> to <span className="font-medium">7</span> of <span className="font-medium">450</span> results
                </p>
                <div className="flex items-center gap-2">
                  ...
                  <div className="hidden sm:flex items-center gap-1">
                    ...
                    <button className="h-8 w-8 rounded-lg text-gray-700 hover:bg-gray-200 text-sm font-medium flex items-center justify-center transition-colors">65</button>
                  </div>
